...
struct	pentry	{
  ...
  /* variables used for Linux Scheduler */
        int 	epochpriority; 		/* prioirty at the start of epoch */	
	int 	counter;		/* To store the amount of quantum remaining in current epoch.*/
	int 	goodness;		/* Scheduler selects process based on this value */
	int 	flagepoch;		/* enabled at start of epoch to differntiate process in the middle of epoch */
